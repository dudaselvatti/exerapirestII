...
import br.ifsp.contacts.dtos.ContactDTO.ContactPatchDTO;
import br.ifsp.contacts.dtos.ContactDTO.ContactRequestDTO;
import br.ifsp.contacts.dtos.ContactDTO.ContactResponseDTO;
...
public class ContactController {
    ...
    public ContactResponseDTO createContact(@Valid @RequestBody ContactRequestDTO dto) {
        ...
        // Mapeia os endereços manualmente para garantir a referência bidirecional correta
